...
private:
    ...
    map<int,Angolo> angolijoint; ////MAP con chiave nome angolo e argomento l'Angolo relativo
    void insert_angolo(int _joint,int a,int b,int c); //Funzione che trasforma 3 coordiante in un'angolo, usata nella funzione public "void completa_angoli();"
public:
