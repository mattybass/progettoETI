...
private:
    ...
    map<string,set<int>> max_min_angoli_zenit; //MAP con chiave nome dell'angolo e argomento una set di massimi e minimi relativi che si discostano di una percentuale x dalla media dell'angolo. Per gli angoli Zenit
    map<string,set<int>> max_min_angoli_azimut;//MAP con chiave nome dell'angolo e argomento una set di massimi e minimi relativi che si discostano di una percentuale x dalla media dell'angolo. Per gli angoli Azimut
    set<int> framedaanalizzare;//Unione di tutti i frame da analizzare
